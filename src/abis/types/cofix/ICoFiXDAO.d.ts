...
export class ICoFiXDAO extends BaseContract {
  ...
  functions: {
    ...
    totalETHRewards(pair: string, overrides?: CallOverrides): Promise<[BigNumber]>
  }
  ...
  callStatic: {
    addETHReward(pair: string, overrides?: CallOverrides): Promise<void>
    ...
    pay(pair: string, tokenAddress: string, to: string, value: BigNumberish, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    addETHReward(pair: string, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    totalETHRewards(pair: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
  }
}
