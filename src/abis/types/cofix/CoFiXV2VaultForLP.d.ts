...
interface CoFiXV2VaultForLPInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initCoFiRate",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "pairToStakingPool",
    values: [string]
  ): string;
  encodeFunctionData(functionFragment: "poolInfo", values: [string]): string;
  encodeFunctionData(
    functionFragment: "setGenesisBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setInitCoFiRate",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "currentPoolRate",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "currentPoolRateByPair",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "stakingPoolForPair",
    values: [string]
  ): string;
  encodeFunctionData(functionFragment: "getPoolInfo", values: [string]): string;
  encodeFunctionData(
    functionFragment: "getPoolInfoByPair",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "getEnabledPoolCnt",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getCoFiStakingPool",
    values?: undefined
  ): string;
...
export class CoFiXV2VaultForLP extends BaseContract {
  ...
  functions: {
    ...
    currentPoolRate(
      pool: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { poolRate: BigNumber }>;

    currentPoolRateByPair(
      pair: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { poolRate: BigNumber }>;
