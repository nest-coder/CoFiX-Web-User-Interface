...
interface CoFiXV2DAOInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "lastCollectingBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "quotaAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "redeemedAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "startedBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CoFiXV2DAO extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { quota: BigNumber }>;
  };
