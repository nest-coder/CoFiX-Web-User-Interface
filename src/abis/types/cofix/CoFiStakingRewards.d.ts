...
interface CoFiStakingRewardsInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "dividendShare",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lastUpdateRewardsTokenBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "pendingSavingAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDividendShare",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "withdrawSavingByGov",
    values: [string, BigNumberish]
  ): string;
