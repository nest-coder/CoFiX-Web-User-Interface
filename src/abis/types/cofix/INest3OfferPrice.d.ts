...
interface INest3OfferPriceInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "checkPriceCostLeast",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "checkPriceCostMost",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "checkPriceCostSingle",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "checkBlocklist",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "checkDestructionAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "checkEffectTime",
    values?: undefined
  ): string;
